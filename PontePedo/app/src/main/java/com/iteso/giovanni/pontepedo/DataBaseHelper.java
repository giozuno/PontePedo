...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DEFAULT_INSERT_GAMES = "insert into GAMES values" +
            "(null,\"Yo Nunca Nunca\",\"Este juego consiste en una ronda en la que cada participante dira una verdad la cual comenzara con la frase YO NUNCA NUNCA... Si alguien ha hecho dicha verdad debera tomar un trago.\")," +
            "(null,\"Animales\",\"En la primera ronda cada participante hara el sonido de un animal sin mostrar los dientes e indicando que animal es, despues los participantes se llamaran entre si primero haciendo su ruido y despues el del compañero al que le hablan (ejemplo: Pollo PIO llamando a pato CUAK). Si alguien muestra los dientes en algun momento, pierde el juego.\")," +
            "(null,\"Historia\",\"Este juego consiste en hacer una historia en la que cada jugador debe repetir la historia creada y agregarle una palabra más (ejemplo: Había --> Había una --> Había una vez). Si alguien se equivoca pierde.\")," +
            "(null,\"Cascada\",\"Todos empiezan a tomar al mismo tiempo, pero solo la persona que saco la carta puede dejar de tomar cuando quiera, y solo cuando el se baje la persona de su derecha se podra bajar y asi sucesivamente hasta que todos dejen de tomar.\")," +
            "(null,\"Palabra Prohibida\",\"El jugador que obtuvo esta carta prohibe una palabra, si algun jugador la dice debera tomar un trago, la palabra cambiara hasta que vuelva a salir esta carta.\")," +
            "(null,\"Preguntas\",\"Este juego lo empezara el jugador que saco la carta, este le hara una pregunta al jugador que quiera, y el preguntado debera hacer otra pregunta a otro jugador diferente y asi sucesivamene. Si alguien tarda en hacer una pregunta o lo que contesta no es pregunta perdera el juego.\")," +
            "(null,\"Mi Pinga - Mi Pepa\",\"Primero se jugara un basta para elegir una letra, despues cada jugador debera decir un adjetivo que empieze con la letra SIN MOSTRAR LOS DIENTES y dependiendo si es hombre (Mi Pinga), o mujer (Mi Pepa) diran su frase: (letra A) Mi pipa es asombrosa, Mi pepa es amable.\")," +
            "(null,\"Dedo\",\"El jugador que obtenga esta carta debe de poner su dedo en un lugar visible (por ejemplo la mesa), esto sera en el momento que el quiera y el ultimo que ponga su dedo donde el lo puso sera el perdedor.\")," +
